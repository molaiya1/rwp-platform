...
const LISTINGS = [
  ...
  },
  {
    ...
    cost: 'Free',
    transportation: 'Not provided — MARTA accessible',
    upcoming: 'Jan 21, 2027',
  },
  {
    id: '13',
    company: 'Warner Bros. Discovery / CNN',
    industry: 'Technology',
    city: 'Atlanta, GA',
    type: 'Site Visit',
    ...
    months: ['Sep', 'Oct', 'Feb', 'Mar', 'Apr'],
    verified: true,
    rating: 4.8,
    reviews: 11,
    photo: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=700&q=80',
    cost: 'Free',
    transportation: 'Not provided — walkable from MARTA Centennial Park',
    upcoming: 'Oct 16, 2026',
  },
  {
    id: '14',
    company: 'Atlanta Hawks / State Farm Arena',
    industry: 'Hospitality',
    city: 'Atlanta, GA',
    type: 'Project Partnership',
    title: 'Sports Business Lab: Run a Real Campaign',
    desc: 'Student teams take on a real sports marketing challenge — fan engagement, merchandise, or community outreach — and present their strategy to Hawks business staff. Winners are featured in arena digital content.',
    grades: '9–12',
    duration: '4 weeks',
    format: 'Hybrid',
    capacity: 24,
    ...
    cost: 'Free',
    transportation: 'Not provided — MARTA State Farm Arena station',
    upcoming: 'Jan 26, 2027',
  },
]
